            ...
            try {
                ...
                p.registerRpcMethod(
                    ...
                    async (data) => {
                        ...
                        // Transform the stringified json to an object
                        const data_transcript = JSON.parse(data.payload);
                        
                        transcript_to_display = ""
                        // prepare a flag depending on the data_transcript.target_language contains french or english
                        if (data_transcript.target_language.includes('fr')) {
                            transcript_to_display = "🇫🇷 " + data_transcript.transcript;
                        } else {
                            transcript_to_display = "🇬🇧 " + data_transcript.transcript;
                        }
                        
                        this.live_info_history.push(transcript_to_display);
